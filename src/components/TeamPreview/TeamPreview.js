                    ...
                    roster.map(player => {
                        ...
                        return(
                            <div className="player">  
                                ...
                                <img title={nationality} src={`https://www.countryflags.io/${nationality}/flat/24.png`} />
                                <span style={{color: color.vibrant}} title={first_name +" "+ last_name} className="player-name-style">{name}</span>

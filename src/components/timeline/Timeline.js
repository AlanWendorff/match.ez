...
const Timeline = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`https://arg-matchez-backend.herokuapp.com/api/timeline`, config).then(({ data }) => {
      setTime(data);
      ...
      if (width === "100%") {
        return (
          <div
            ...
            className="time-line-container font-gilroy"
                  ...
                  >
                    ...
                    <div className="column-align mb-5px">
                      <h5
                        ...
                        className="vertical-timeline-element-subtitle name-of-tournament tournament-data"
                      >

...
const CompetitionCard = ({ match, palette }) => {
    const { opponents, league, begin_at, stage, serie, bestOf, status, official_stream_url, results } = match;
                            ...
                            <div className="match-data">
                                <span className="font-size text-align-start">
                                    <span style={{ color: palette.DarkVibrant }}>
                                        <FontAwesomeIcon className="turn-left-90" icon={faCodeBranch} />
                                    </span>
            ...
            >
                <div className="card-image">
                    <p className="text-align-center cursor-default font-size mb-0">
                        <span className="text-center head-font font-gilroy-bold" style={{ color: palette.Vibrant }}>
                            {" "}
                            {league.name.toUpperCase() + " " + serie.full_name.toUpperCase()}{" "}
                        </span>
                    </p>
                                ...
                                <div className="team-canvas">
                                    <ProgressiveImage src={TeamLogoA} placeholder={loader}>
                                        {(src) => (
                                            <img
                                                title={
                                                    aTeamName !== "To be defined" ? LOOKPROFILE + aTeamName : undefined
                                                }
                                                alt="a team"
                                                className="size-team-logo"
                                                src={src}
                                ...
                                <div className="team-canvas">
                                    <ProgressiveImage src={TeamLogoB} placeholder={loader}>
                                        {(src) => (
                                            <img
                                                title={
                                                    bTeamName !== "To be defined" ? LOOKPROFILE + bTeamName : undefined
                                                }
                                                alt="b team"
                                                className="size-team-logo"
                                                src={src}
